...
def getFolderFromDialog(hndle, className):
    ...
    only print details if Adres: of Address: is found... (Dutch English windows versions currently)
    """
    if className == '#32770':
        controls = findControls(hndle, selectionFunction=selFuncExplorerAddress)
        if controls:
...
def testExplorerViews(hndle):
    win32gui.PostMessage(hndle, 28715, 0, 0)
...
if __name__ == '__main__':
    ...
    # view settings explorer:
    testExplorerViews(134278)