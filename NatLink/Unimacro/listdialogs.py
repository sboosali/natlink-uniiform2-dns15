pen__version__ = "$Revision: 561 $, $Date: 2015-11-01 18:03:43 +0100 (zo, 01 nov 2015) $, $Author: quintijn $"
...
##        print 'List: %s'% List
    ...
    def FillList(self):
        ...
        for item in self.items:
            ...
            itemText=string.lstrip(str(item))
...
def caseIndependentSort(something, other):
    something, other= string.lower(repr(something)),string.lower(repr(other))
