__version__ = "$Rev: 583 $ on $Date: 2018-01-19 14:04:38 +0100 (vr, 19 jan 2018) $ by $Author: quintijn $"
...
import natlinkstatus  # newer: expandEnvVars
...
##        print '-------drive words: %s'% words
    ...
    def substituteFolder(self, folder):
        ...
        #print 'folder for substitute: %s'% folder
    ...
    def substituteEnvVariable(self,folder):
        ...
        """
        substitute = natlinkstatus.expandEnvVars(folder)
        # 
